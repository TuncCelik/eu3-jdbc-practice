...
public class simpleGetRequest {
    String hrurl = "http://100.25.204.38:1000/ords/hr/regions";
    @Test
    public void test1(){
    ...
    //*********YUKARIDAKI ISLEMI API RESTASSURED ILE YAPABILIYORUZ*************
    @Test
    public void test3(){
        RestAssured.given().accept(ContentType.JSON)
                ...
                //daha okunabilir olmasi icin when, then, and'leri koyuyoruz.Zorunlu degil.
